...
namespace BibleTalk.Data.Repositories
{
    public class NotificationRepository : INotificationRepository
    {
        ...
        public void Create(Notification notification, long channelId)
        {
            ...
            var channel = _context.BibleTalk.Include(c => c.Subscribers).ThenInclude(m => m.Subscriber).ThenInclude(m => m.Identity).FirstOrDefault(c => c.Id == channelId);
